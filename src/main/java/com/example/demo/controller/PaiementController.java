...
@RestController
    @RequestMapping("/api/v3/Paiement")
...
public class PaiementController {
  ...
  /*  @GetMapping("/getPaimentbyEnrollement_id/{enrollement_id}")
    public ResponseEntity<List<Paiement>> getPaimentbyEnrollement_id(@PathVariable("enrollement_id") int enrollement_id ) {

        List<Paiement> paiements = paiementService.getPaimentbyEnrollement_id(enrollement_id);
